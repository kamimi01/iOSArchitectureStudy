...
- [「iOSアプリ設計パターン入門」から学ぶ、設計の基礎](#iosアプリ設計パターン入門から学ぶ設計の基礎)
  ...
  - [GUIアーキテクチャ](#guiアーキテクチャ)
    ...
    - [その他の整理](#その他の整理)
      ...
      - [「iOSアプリ設計パターン入門」を読んで考えたアーキテクチャ採用戦略](#iosアプリ設計パターン入門を読んで考えたアーキテクチャ採用戦略)
      - [MVPのSupervising ViewとPassive View](#mvpのsupervising-viewとpassive-view)
